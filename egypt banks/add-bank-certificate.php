...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $revenue_frequency = $_POST['revenue_frequency'];
        $min_amount = $_POST['min_amount'];
        $period = $_POST['period'];

        $query = "insert into certificate (bank_name,name,annual_revenue,revenue_frequency,period,min_amount) values ('$bank_name','$name','$annual_revenue','$revenue_frequency','$period','$min_amount')";
        $result = mysqli_query($con, $query);

        if($result) {
            $msg = "Successfully added the Certificate!";
        } else {
            $msg = "Error adding the Certificate!";
        }
    }
?>
...
<body>
    ...
    <section class="container">
        <h1>Add New Bank Certificate</h1>
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" placeholder="Certificate Name" name="name" required>
                </div>
            </div>

            <div class="row mb-3">
                <div class="col">
                    <label>Annual Revenue (in %)</label>
                    <input type="number" class="form-control" placeholder="Annual Revenue" name="annual_revenue"
                        required>
                </div>
                <div class="col">
                    <label>Revenue Frequency</label>
                    <select class="form-control mb-3" name="revenue_frequency" required>
                        <option disabled selected value>Revenue Frequency</option>
                        <option>Every Month</option>
                        <option>Every 3 Months</option>
                        <option>Every 6 Months</option>
                        <option>Every Year</option>
                        <option>At The end of the period</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <label>Certificate Total Period</label>
                    <select class="form-control mb-3" name="period" required>
                        <option disabled selected value>Certificate Period</option>
            ...
            <button type="submit" class="btn btn-primary">Add Bank Certificate</button>
            <?php echo $msg ?>
        </form>
    </section>
