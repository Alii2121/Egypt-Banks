...
session_start();
    ...
    $all_certificates_query = "select * from certificate";
    $all_certificates = mysqli_query($con, $all_certificates_query);
?>
...
<body>
    ...
    <section>
        <h2>Compare Bank Certificates</h2>
        <table class="table table2 table-striped">
            <thead>
                <tr>
                    ...
                    <th>Certificate Period</th>
                    <th>Minimum Amount</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    while($row = mysqli_fetch_array($all_certificates)) {
                ?>
                <tr>
                <td><a  href="bank-<?php echo strtolower($row['bank_name']); ?>.php"><?php echo $row['bank_name'] ?></a></td>
                    <td><?php echo $row['name'] ?></td>
                    <td><?php echo $row['annual_revenue'] ?> %</td>
                    <td><?php echo $row['revenue_frequency'] ?></td>
                    <td><?php echo $row['period'] ?></td>
                    <td><?php echo $row['min_amount'] ?> L.E</td>
                </tr>
