...
session_start();
    ...
    $all_accounts_query = "select * from accounts";
    $all_accounts = mysqli_query($con, $all_accounts_query);
?>
...
<body>
    ...
    <section>
        ...
        <table class="table table2 table-striped">
            ...
            <tbody>
                <?php
                    while($row = mysqli_fetch_array($all_accounts)) {
                ?>
                <tr>
