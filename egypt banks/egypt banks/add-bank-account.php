...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $query = "insert into accounts (bank_name,name,type,benefit,min_amount) values ('$bank_name','$name','$type','$benefit','$min_amount')";
        $result = mysqli_query($con, $query);

        if($result) {
            $msg = "Successfully added the Account!";
        } else {
            $msg = "Error adding the Account!";
        }
    }
?>
...
<body>
    ...
    <section class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label>Account Benefits (in %)</label>
                    <input type="number" class="form-control" placeholder="Account Benefits" name="benefit" required>
                </div>
                <div class="col">
                    <label>Account Minimum Amount (in L.E)</label>
                    <input type="number" class="form-control" placeholder="Account Minimum Amount" name="min_amount"
                        required>
                </div>
            </div>
