...
session_start();
    ...
    $bank_treasury_query = "select * from treasuries where user_id = '$user_id'";
    $bank_treasury = mysqli_query($con, $bank_treasury_query);

    $bank_visit_query = "select * from bank_visits where user_id = '$user_id'";
...
<body>
    ...
    <section class="container">
        <div>
            <h1>My Bank Treasury Bookings</h1>
            <div class="row">
